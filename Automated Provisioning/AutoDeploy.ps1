...
<Window
        ...
        Title="Credentials" Height="314" Width="726" BorderBrush="$Script:ForegroundColor" Background='$Script:BackgroundColor' ResizeMode="NoResize" WindowStartupLocation="CenterScreen" >
    <Grid>
